...
function xmldb_local_socialenergy_install() {
    ...
    $reports = array(
        ...
        array('idnumber' => 2, 'name' => 'Last week\'s total score', 'description' => 'Sum of LCMS scores from all courses since end user\'s 1st registration',
             'datefrom' => '-7 day', 'datetill' => null, 'competencyids' => null, 'courseids' => null),
        array('idnumber' => 3, 'name' => 'Last month\'s total score', 'description' => 'Sum of LCMS scores from all courses since end user\'s 1st registration',
        ...
        array('idnumber' => 15, 'name' => 'Last month\'s total score for competence 4', 'description' => 'Sum of LCMS scores only for competence 4 courses for the last 40 days',
             'datefrom' => '-40 day', 'datetill' => null, 'competencyids' => '4.1,4.2,4.3', 'courseids' => null),
        ...
        array('idnumber' => 18, 'name' => 'Last month\'s total score for competence 5', 'description' => 'Sum of LCMS scores only for competence 5 courses for the last 50 days',
             'datefrom' => '-50 day', 'datetill' => null, 'competencyids' => '5.1,5.2,5.3', 'courseids' => null),
        ...
        array('idnumber' => 21, 'name' => 'Last month\'s total score for competence 6', 'description' => 'Sum of LCMS scores only for competence 6 courses for the last 60 days',
             'datefrom' => '-60 day', 'datetill' => null, 'competencyids' => '6.1,6.2,6.3', 'courseids' => null),
        ...
        array('idnumber' => 24, 'name' => 'Last month\'s total score for competence 7', 'description' => 'Sum of LCMS scores only for competence 7 courses for the last 70 days',
             'datefrom' => '-70 day', 'datetill' => null, 'competencyids' => '7.1,7.2,7.3', 'courseids' => null),
    );
